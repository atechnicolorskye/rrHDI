  ...
  for (i in 1:length(n_list)){
    ...
    for (i in 1:nsim){
      ...
      if (nsolve > 0) {
        ...
        ## 4. SILM
        print("> SILM")
        ci_silm = SimE.CI(x, y, ind_0, ind_1, M = 1000, alpha = 0.95)
      ...
      out_rr = riSingle_hdi_dantzig(y, x, t(M), ind_0, beta_0, ind_1, beta_1, g_design, TRUE)
